...
Trong tin sinh học, một bộ dữ liệu giải trình tự có thể chứa đến hàng tỷ bản ghi và chiếm hàng chục hoặc hàng trăm gigabyte dung lượng. Đặc điểm này khiến các phần mềm giao diện đồ hoạ người dùng (GUI) như Excel hoặc Word trở nên rất hạn chế trong việc lưu trữ và dễ quá tải khi thao tác phức tạp. Để khắc phục nhược điểm này, các nhà tin sinh học thường làm việc thông qua giao diện dòng lệnh (CLI). Thay vì phải nạp toàn bộ tệp vào một cửa sổ, các công cụ dòng lệnh có thể đọc dữ liệu tuần tự theo dòng, xử lý từng bản ghi và truyền kết quả trực tiếp cho công cụ tiếp theo. Cách làm này đặc biệt hiệu quả với dữ liệu dạng văn bản, các tệp nén và những tác vụ lặp lại. Nó cũng giúp ghi lại chính xác các bước phân tích, từ đó làm cho quy trình dễ kiểm tra và tái lập hơn. CLI còn là phương thức phổ biến để đăng nhập vào máy chủ từ xa, truyền dữ liệu và gửi tác vụ lên hệ thống quản lý của cụm máy tính hiệu năng cao (HPC).

[^note: Bash: Bourne Again Shell]

Để tương tác với CLI, ta sử dụng một ứng dụng gọi là Terminal. Bên trong Terminal sẽ chạy một chương trình thông dịch lệnh gọi là Shell, trong đó phổ biến nhất là Bash. Shell đóng vai trò làm cầu nối tiếp nhận câu lệnh văn bản bạn nhập, thông dịch rồi yêu cầu hệ điều hành thực thi và hiển thị kết quả trở lại.

Hầu hết các công cụ và quy trình tin sinh học hiện đại đều được phát triển và tối ưu hoá cho hệ sinh thái Unix/Linux. Trên Linux và macOS, hệ điều hành đã dựa trên nền tảng Unix, do đó có thể bắt đầu từ việc dùng Terminal có sẵn. Trên Windows, môi trường dòng lệnh mặc định (PowerShell / Command Prompt) có sự khác biệt so với chuẩn Unix. Để học và chạy các công cụ tin sinh học thuận tiện nhất, giải pháp phổ biến hiện nay là cài đặt Windows Subsystem for Linux (WSL). Đây là một môi trường cho phép chạy trực tiếp hệ điều hành Linux bên trong Windows. Bạn có thể tham khảo hướng dẫn [cài đặt WSL](https://youtu.be/mbFA7zjD2ps?si=-dDqeOZm6GclxQk5) để sử dụng thông qua Windows Terminal, hoặc [cài đặt máy ảo](https://youtu.be/Hva8lsV2nTk?si=f7rNg4RM2SfwOgML) để chạy hệ điều hành Linux song song với Windows.
...
Kho lưu trữ tài liệu **[Github](https://github.com/luuloi/Cancer_Epigenetics)** của lớp **[Cancer Epigenetics](https://youtube.com/playlist?list=PLXtgXP89Tyn9AvPFJWi7znv_bCJHiSvqG&si=mIBuqodWd5Z8sQWH)** (được dạy bởi TS. Lưu Phúc Lợi) cũng là một nguồn tài liệu rất đáng tham khảo khi ta có thể quan sát cách mà Bash được ứng dụng để giải quyết các vấn đề sinh học hiện đại cụ thể, ví dụ như di truyền học biểu sinh ung thư.
