...
abstract: "Explaining why your storage drive suddenly runs out of disk space when using WSL, why ext4.vhdx doesn't shrink automatically after deleting files, and step-by-step instructions to clean up and compact virtual disks with diskpart."
